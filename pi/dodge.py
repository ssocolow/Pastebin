  ...
  if c % 3 == 0:
    for ast in asteroids:
      if ast[1] == 0:
        ...
        sense.set_pixel(0,ast[1],[0,0,0])
        sense.set_pixel(1,ast[1],[0,0,0])
        sense.set_pixel(2,ast[1],[0,0,0])
        sense.set_pixel(3,ast[1],[0,0,0])
        ast[1] -= 1
        sense.set_pixel(0,ast[1],[255,0,0])
        sense.set_pixel(1,ast[1],[255,0,0])
        sense.set_pixel(2,ast[1],[255,0,0])
        sense.set_pixel(3,ast[1],[255,0,0])
      else:
        sense.set_pixel(4,ast[1],[0,0,0])
        sense.set_pixel(5,ast[1],[0,0,0])
        sense.set_pixel(6,ast[1],[0,0,0])
        sense.set_pixel(7,ast[1],[0,0,0])
        ast[1] -= 1
        sense.set_pixel(4,ast[1],[255,0,0])
        sense.set_pixel(5,ast[1],[255,0,0])
        sense.set_pixel(6,ast[1],[255,0,0])
        sense.set_pixel(7,ast[1],[255,0,0])
